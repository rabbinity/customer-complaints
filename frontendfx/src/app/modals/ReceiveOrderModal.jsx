...
const ReceiveOrderModal = ({ isOpen, onClose, onOrderReceived }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_URL}/api/A/order/receive`, { orderId });
      setBackendResponse(response.data);
      onOrderReceived && onOrderReceived(response.data);
      setOrderId("");
    } catch (err) {
